...
//echo $_POST['fileup'],'/',$$_GET['id'];
    ...
    //move_uploaded_file($_FILES['fileup']['tmp_name'],"../fileproj/".$filetrue);
     if(move_uploaded_file($_FILES['fileup']['tmp_name'],"../filecommit/".$filetrue)){
         //echo $filetrue;
                 $sql_upp ='INSERT INTO tbl_up_pro (UpID,UpProID,UpFile,UpUserID,UpDateTime) VALUES (NULL,"'.$_GET['id'].'","'.$filetrue.'","'.$_SESSION['ssUserID'].'",NOW())';
